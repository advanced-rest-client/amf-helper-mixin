...
ns.aml.vocabularies.apiContract.operationKind = `${contractKey}operationKind`;
ns.aml.vocabularies.apiContract.parentTag = `${contractKey}parentTag`;
ns.aml.vocabularies.apiContract.action = `${contractKey}action`;
ns.aml.vocabularies.apiContract.channel = `${contractKey}channel`;
ns.aml.vocabularies.apiContract.operationMessages = `${contractKey}operationMessages`;
ns.aml.vocabularies.apiContract.channelMessages = `${contractKey}channelMessages`;
